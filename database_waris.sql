...
-- -----------------------------------------------------
-- Table `waris`.`pengguna`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `waris`.`pengguna` (
...
CREATE TABLE IF NOT EXISTS `waris`.`kategori` (
  ...
  UNIQUE INDEX `nama_kategori_UNIQUE` (`nama_kategori` ASC) VISIBLE);
...
CREATE TABLE IF NOT EXISTS `waris`.`favorit` (
  ...
  INDEX `fk_Favorit_User1_idx` (`pengguna_id` ASC) VISIBLE,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `waris`.`review` (
  ...
  `create_time` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  INDEX `fk_Review_User1_idx` (`pengguna_id` ASC) VISIBLE,
